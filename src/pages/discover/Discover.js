  ...
  return (
    <>
      <div className="discoveryHeading discoveryHeading-mobile">
        Discover the latest and trending insights in the{" "}
        <span className="vestColor">VestorGrow</span> Community
      </div>
            ...
            <ul className="dropdown-menu">
              ...
              <li>
                <a
                  className="dropdown-item"
                  href="#"
                  onClick={() => handleSorting("Trending")}
                >
                  Trending
                </a>
              </li>
                      ...
                      <div className="grid-details">
                        <div className="grid-user">
                          <ProfilePreview
                            ...
                            profile_img={item.createdBy?.profile_img}
                            section="discovery"
                          />
                          <span className="grid-user-name">
                            {user_name.length > 12
                              ? user_name.slice(0, 12) + "..."
                              : user_name}
                          </span>
                        ...
                        <p
                          ...
                          dangerouslySetInnerHTML={{ __html: postMessage }}
                        />
                      </div>
                    </div>
                  </div>
