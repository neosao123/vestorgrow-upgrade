              ...
              <ul className="feedChatHeadLeft nav">
                <li className="groupIcon groupIconCustom position-relative">
                  <a
                    ...
                    className={"groupfeed nav-link nav-link-Custom " + (activeChat === 1 && "active")}
                    data-bs-toggle="tab"
                    role="tab"
                  ...
                  {unreadMsgCount.messageChat !== 0 && (
                    <span className="badge rounded-pill bg-danger position-absolute">{unreadMsgCount.messageChat}</span>
                  )}
                </li>
                <li className="groupIcon groupIconCustom position-relative">
                  <a
                  ...
                  {groupChat !== 0 && (
                    <span className="badge rounded-pill bg-danger position-absolute">{groupChat}</span>
                  )}
                </li>
                {(user.role.includes("admin") || user.role.includes("userPaid")) && (
                  <li className="groupIcon groupIconCustom position-relative">
                    <a
                      ...
                      className={"groupfeed nav-link nav-link-Custom " + (activeChat === 0 && "active")}
                      data-bs-toggle="tab"
                      role="tab"
                    ...
                    {premiumChat !== 0 && (
                      <span className="badge rounded-pill bg-danger position-absolute">{premiumChat}</span>
                    )}
                  </li>
                )}
              </ul>
